        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_TradeOffer_DifferentUsers", "[SenderId] != [ReceiverId]");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CardInfos_CardSets_CardSetId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsAvailableForTrade = table.Column<bool>(type: "bit", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Cards_CardInfos_CardInfoId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<int>(type: "int", nullable: false),
                    CardInfoId = table.Column<int>(type: "int", nullable: false),
                    PreferredCondition = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WishlistItems_CardInfos_CardInfoId",
                        column: x => x.CardInfoId,
                        principalTable: "CardInfos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CardInfos_CardSetId_Name",
                table: "CardInfos",
                columns: new[] { "CardSetId", "Name" });

            migrationBuilder.CreateIndex(
                name: "IX_Cards_CardInfoId",
                table: "Cards",
                column: "CardInfoId");

            migrationBuilder.CreateIndex(
                name: "IX_Cards_UserId_CardInfoId",
                table: "Cards",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WishlistItems_CardInfoId",
                table: "WishlistItems",
                column: "CardInfoId");

            migrationBuilder.CreateIndex(
                name: "IX_WishlistItems_UserId_CardInfoId",
                table: "WishlistItems",
                columns: new[] { "UserId", "CardInfoId" },
                unique: true);
        }
